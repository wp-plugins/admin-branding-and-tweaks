<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php _e('Import', 'wp_branding_textdomain') ?>
		</label>
		<div class="description">
			<p><?php _e('Import Options', 'wp_branding_textdomain') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-import" class="vp-button button" type="button" value="<?php _e('Import', 'wp_branding_textdomain') ?>" />
...
<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php _e('Export', 'wp_branding_textdomain') ?>
		</label>
		<div class="description">
			<p><?php _e('Export Options', 'wp_branding_textdomain') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
			...
			<div class="buttons">
				<input id="vp-js-export" class="vp-button button" type="button" value="<?php _e('Export', 'wp_branding_textdomain') ?>" />
				<span style="margin-left: 10px;">
